...
public interface PayMerchantMapper {
    ...
    @Select("select id, merchant_no as merchantNo, alipay_merchant_no as alipayMerchantNo, name, status, is_default as isDefault, remark, create_time as createTime, update_time as updateTime "
    ...
    @Insert("insert into pay_merchant (merchant_no, alipay_merchant_no, name, status, is_default, remark) "
        + "values (#{merchantNo}, #{alipayMerchantNo}, #{name}, #{status}, #{isDefault}, #{remark})")
